   ...
   'use strict';
    ...
    MAYOSISLIB = {
        ...
        init: function () {
            ...
            window.elementor.on(
                'document:loaded',
                window._.bind(MAYOSISLIB.onPreviewLoaded, MAYOSISLIB)
            );
        },
        ...
        onPreviewLoaded: function () {
            ...
            var wrapper_html = "<div style='display:none;' class='lib-wrap'>"
                                    +"<div class='lib-inner'>"
                                        +"<div class='header'>"
                                            +"<div class='lhead'>"
                                                +"<h2 class='lib-logo'>Mayosis Library</h2>"
            ...
            main_wrap.find('.elementor-add-template-button').after("<div class='elementor-add-section-area-button xltab-add-section-btn' style='background:#e7eff7;margin-left:10px;'><img src='https://mayo.teconcetheme.com/template-lib/wp-content/uploads/2021/12/icon-1.png' style='width:16px;'></div>");
            ...
            $(document).on('click', '.insert-tmpl', function(e) {
                ...
                $.ajax({
                    ...
                    url: ajaxurl,
                    data: {
                      action: 'mayosis_lib_import_template',
                      id: tmpl_id,
                    },
            ...
            $(document).on('click', '.rhead .eicon-sync', function(e) {
                ...
                $.ajax({
                    ...
                    url: ajaxurl,
                    data: {
                      action: 'mayosis_lib_reload_template',
                    },
                    success: function(data, textStatus, XMLHttpRequest) {
                        $('.xl-loader').hide();
                        var ajax_data = {
    ...
    $(window).on('elementor:init', MAYOSISLIB.init);
