...
(function($){
    ...
    $( window ).on( 'elementor/frontend/init', function() {
          ...
          var EmerceCOunterProduct = function (){
        ...
        $('#emercetimeralt').countDown();
           ...
           var EmerceFlashslaecountProduct = function (){
        // You can put any js function here without windows on load
        $('#emrc-flash-offer-count').countDown();
         ...
         var EmerceProductCarousel = function (){
             
             
        var pivooslidethumbs = new Swiper("#emerce-product-carousel-box", {
             spaceBetween: 32,
        slidesPerView: "auto",
        centeredSlides: true,
        autoHeight: true,
         ...
         navigation: {
          nextEl: ".emerce-swiper-button-next",
          prevEl: ".emerce-swiper-button-prev",
        },
         ...
         var EmercecatCarouselProduct = function (){
             
             
        var pivooslidethumbs = new Swiper("#emerce-cat-carousel-box", {
        spaceBetween: 32,
        slidesPerView: 4,
        freeMode: false,
        ...
        autoHeight: true,
         ...
         navigation: {
          ...
          prevEl: ".emerce-swiper-button-prev",
           ...
           var EmercecatCarouselReview = function (){
        ...
        var pivooreviwslides = new Swiper("#emerce-review-slider-swipe", {
        spaceBetween: 0,
        slidesPerView: 1,
        freeMode: false,
        watchSlidesProgress: true,
        ...
        autoHeight: true,
         navigation: {
          nextEl: ".emerce-swiper-button-next-review",
          prevEl: ".emerce-swiper-button-prev-review",
        },
       ...
       var pivooreviwslidesthree = new Swiper("#emerce-review-slider-swipe-three", {
        spaceBetween: 0,
        slidesPerView: 1,
        freeMode: false,
        watchSlidesProgress: true,
    ...
    elementorFrontend.hooks.addAction( 'frontend/element_ready/emerce_timing_counter_product.default', function($scope, $){
    
           
                EmerceCOunterProduct();
    } );
    
    elementorFrontend.hooks.addAction( 'frontend/element_ready/emerce_product_category_carousel.default', function($scope, $){
    
           
                EmercecatCarouselProduct();
    } );
    
     elementorFrontend.hooks.addAction( 'frontend/element_ready/emerce_client_review.default', function($scope, $){
    
           
                EmercecatCarouselReview();
    } );

        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/emerce_product_carousel.default', function($scope, $){
        EmerceProductCarousel();
        } );
        
        
         elementorFrontend.hooks.addAction( 'frontend/element_ready/emerce_sale_flash_product_grid.default', function($scope, $){
         EmerceFlashslaecountProduct();
        } );
