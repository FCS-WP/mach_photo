...
class emerce_logo extends Widget_Base {

   public function get_name() {
      return 'emerce_main_logo';
   }

   public function get_title() {
      return __( 'Logo', 'emerce' );
   }
public function get_categories() {
   ...
   protected function register_controls() {
      ...
      $this->start_controls_section(
			'emerce_logo_section_control',
			[
				'label' => __( 'Emerce Logo', 'elementor' ),
			]
		);
      ...
      $this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .emerce-logo' => 'text-align: {{VALUE}};',
				],
			]
		);
...
?>
		...
		<a class="site-main-logo-elementor" href="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    <?php } else {?>
                  <img src="<?php echo get_template_directory_uri();?>/image/emerce-logo-2x.svg" alt="logo">
                  <?php }?>
...
Plugin::instance()->widgets_manager->register_widget_type( new emerce_logo );
?>