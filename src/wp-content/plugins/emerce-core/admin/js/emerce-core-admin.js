...
jQuery(document).ready(function ($) {
  $('.box-xpc-media-nav').addClass('emerce-upload-file-system');

  $.wpMediaUploader = function (options) {

    var settings = $.extend({

      target: '.emerce-upload-file-system', // The class wrapping the textbox
      ...
      buttonClass: '.emerce-upload-button', // the class of the upload button
