...
$product_style = cs_get_option('emerce-archive-style');
...
<div class="col mb-4">
    ...
    <?php } elseif ($product_style == "style-eight") { ?>
        ...
        <?php get_template_part('inc/vendor/woocommerce/product-style/content-style-eight'); ?>
         ...
         <?php } elseif ($product_style == "style-nine") { ?>

        <?php get_template_part('inc/vendor/woocommerce/product-style/content-style-nine'); ?>
        
        
         <?php } elseif ($product_style == "style-ten") { ?>

        <?php get_template_part('inc/vendor/woocommerce/product-style/content-style-ten'); ?>
        
         <?php } elseif ($product_style == "style-eleven") { ?>
